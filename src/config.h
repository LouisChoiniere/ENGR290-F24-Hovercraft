...
#define TRUNING_FRONT_DISTANCE_THRESHOLD_CM 40
...
// Resume
#define DROP_TIME_MS 750

// Forward
#define FORWARD_DISTANCE_THRESHOLD_1_CM 40
#define MIN_FORWARD_TIME_2_MS 2500
